...
const env = envalid.cleanEnv(processEnvObject, rule, {
    dotEnvPath: envFieldName, strict: true,
});
...
if (config.type === 'mysql') {
    Object.assign(config, {
        charset: 'utf8mb4',
        collation: 'utf8mb4_unicode_ci', // https://stackoverflow.com/questions/35553432/error-handshake-inactivity-timeout-in-node-js-mysql-module
